...
var SidebarComponent = class _SidebarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _SidebarComponent, selectors: [["app-sidebar"]], decls: 19, vars: 0, consts: [[1, "sidebar"], [1, "brand"], [1, "brand-mark"], [1, "brand-title"], [1, "brand-subtitle"], ["routerLinkActive", "active", 1, "nav-item", 3, "routerLink"], [1, "responsible-ai"], [1, "mini-title"], [1, "mini-text"], [1, "nav-icon"]], template: function SidebarComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275text(10, "10 gates to readiness");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(11, "nav");
      \u0275\u0275repeaterCreate(12, SidebarComponent_For_13_Template, 5, 3, "a", 5, _forTrack0);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(14, "div", 6)(15, "div", 7);
      \u0275\u0275text(16, "Responsible AI");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(17, "div", 8);
      \u0275\u0275text(18, "Human-approved, policy-backed and audit-ready.");
      \u0275\u0275elementEnd()()();
    }
    if (rf & 2) {
      \u0275\u0275advance(12);
  ...
  }, dependencies: [RouterLink, RouterLinkActive], styles: ["\n\n.sidebar[_ngcontent-%COMP%] {\n  position: sticky;\n  top: 0;\n  width: 250px;\n  min-height: 100vh;\n  padding: 20px 14px;\n  color: #fff;\n  background:\n    radial-gradient(\n      circle at top left,\n      #183d8f 0,\n      var(--db-navy) 38%,\n      #00132f 100%);\n}\n.brand[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  margin-bottom: 24px;\n}\n.brand-mark[_ngcontent-%COMP%] {\n  width: 42px;\n  height: 42px;\n  border-radius: 14px;\n  display: grid;\n  place-items: center;\n  background: #fff;\n  color: var(--db-blue);\n  font-weight: 900;\n}\n.brand-title[_ngcontent-%COMP%] {\n  font-size: 18px;\n  font-weight: 850;\n}\n.brand-title[_ngcontent-%COMP%]   span[_ngcontent-%COMP%] {\n  color: #8ea3ff;\n}\n.brand-subtitle[_ngcontent-%COMP%] {\n  font-size: 11px;\n  color: #b9c7e9;\n  margin-top: 2px;\n}\n.nav-item[_ngcontent-%COMP%] {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 11px 12px;\n  margin: 4px 0;\n  border-radius: 12px;\n  color: #d6def4;\n  font-size: 14px;\n  font-weight: 650;\n}\n.nav-item[_ngcontent-%COMP%]:hover, \n.nav-item.active[_ngcontent-%COMP%] {\n  color: #fff;\n  background:\n    linear-gradient(\n      135deg,\n      var(--db-blue),\n      #3662ff);\n}\n.nav-icon[_ngcontent-%COMP%] {\n  width: 22px;\n  text-align: center;\n}\n.responsible-ai[_ngcontent-%COMP%] {\n  margin-top: 26px;\n  padding: 14px;\n  border-radius: 16px;\n  background: rgba(255, 255, 255, 0.1);\n  border: 1px solid rgba(255, 255, 255, 0.16);\n}\n.mini-title[_ngcontent-%COMP%] {\n  font-size: 13px;\n  font-weight: 800;\n}\n.mini-text[_ngcontent-%COMP%] {\n  margin-top: 6px;\n  font-size: 12px;\n  color: #cbd8f7;\n  line-height: 1.35;\n}\n@media (max-width: 850px) {\n  .sidebar[_ngcontent-%COMP%] {\n    display: none;\n  }\n}\n/*# sourceMappingURL=sidebar.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SidebarComponent, [{
    type: Component,
    args: [{ selector: "app-sidebar", standalone: true, imports: [RouterLink, RouterLinkActive], template: '<aside class="sidebar">\n  <div class="brand">\n    <div class="brand-mark">10</div>\n    <div>\n      <div class="brand-title">Onboard10 <span>AI</span></div>\n      <div class="brand-subtitle">10 gates to readiness</div>\n    </div>\n  </div>\n\n  <nav>\n    @for (item of navItems; track item.route) {\n      <a [routerLink]="item.route" routerLinkActive="active" class="nav-item">\n        <span class="nav-icon">{{ item.icon }}</span>\n        <span>{{ item.label }}</span>\n      </a>\n    }\n  </nav>\n\n  <div class="responsible-ai">\n    <div class="mini-title">Responsible AI</div>\n    <div class="mini-text">Human-approved, policy-backed and audit-ready.</div>\n  </div>\n</aside>\n', styles: ["/* src/app/layout/sidebar/sidebar.component.scss */\n.sidebar {\n  position: sticky;\n  top: 0;\n  width: 250px;\n  min-height: 100vh;\n  padding: 20px 14px;\n  color: #fff;\n  background:\n    radial-gradient(\n      circle at top left,\n      #183d8f 0,\n      var(--db-navy) 38%,\n      #00132f 100%);\n}\n.brand {\n  display: flex;\n  align-items: center;\n  gap: 12px;\n  margin-bottom: 24px;\n}\n.brand-mark {\n  width: 42px;\n  height: 42px;\n  border-radius: 14px;\n  display: grid;\n  place-items: center;\n  background: #fff;\n  color: var(--db-blue);\n  font-weight: 900;\n}\n.brand-title {\n  font-size: 18px;\n  font-weight: 850;\n}\n.brand-title span {\n  color: #8ea3ff;\n}\n.brand-subtitle {\n  font-size: 11px;\n  color: #b9c7e9;\n  margin-top: 2px;\n}\n.nav-item {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n  padding: 11px 12px;\n  margin: 4px 0;\n  border-radius: 12px;\n  color: #d6def4;\n  font-size: 14px;\n  font-weight: 650;\n}\n.nav-item:hover,\n.nav-item.active {\n  color: #fff;\n  background:\n    linear-gradient(\n      135deg,\n      var(--db-blue),\n      #3662ff);\n}\n.nav-icon {\n  width: 22px;\n  text-align: center;\n}\n.responsible-ai {\n  margin-top: 26px;\n  padding: 14px;\n  border-radius: 16px;\n  background: rgba(255, 255, 255, 0.1);\n  border: 1px solid rgba(255, 255, 255, 0.16);\n}\n.mini-title {\n  font-size: 13px;\n  font-weight: 800;\n}\n.mini-text {\n  margin-top: 6px;\n  font-size: 12px;\n  color: #cbd8f7;\n  line-height: 1.35;\n}\n@media (max-width: 850px) {\n  .sidebar {\n    display: none;\n  }\n}\n/*# sourceMappingURL=sidebar.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(SidebarComponent, { className: "SidebarComponent", filePath: "src/app/layout/sidebar/sidebar.component.ts", lineNumber: 17 });
})();
...
var TopbarComponent = class _TopbarComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TopbarComponent, selectors: [["app-topbar"]], decls: 18, vars: 2, consts: [[1, "topbar"], [1, "eyebrow"], [1, "top-actions"], ["routerLink", "/policy-assistant", 1, "icon-btn"], [1, "icon-btn"], [1, "avatar"], [1, "user"]], template: function TopbarComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "header", 0)(1, "div")(2, "div", 1);
      \u0275\u0275text(3, "Deutsche Bank Hackathon \xB7 10th Anniversary Twist");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(4, "strong");
      \u0275\u0275text(5, "Onboard10 AI Control Tower");
      \u0275\u0275elementEnd()();
      ...
      \u0275\u0275text(12, "JS");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(13, "div", 6)(14, "strong");
      \u0275\u0275text(15);
      \u0275\u0275elementEnd();
    ...
    if (rf & 2) {
      \u0275\u0275advance(15);
      \u0275\u0275textInterpolate(ctx.state().profile.fullName);
      \u0275\u0275advance(2);
      \u0275\u0275textInterpolate(ctx.state().profile.role);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TopbarComponent, [{
    type: Component,
    args: [{ selector: "app-topbar", standalone: true, imports: [RouterLink], template: '<header class="topbar">\n  <div>\n    <div class="eyebrow">Deutsche Bank Hackathon \xB7 10th Anniversary Twist</div>\n    <strong>Onboard10 AI Control Tower</strong>\n  </div>\n  <div class="top-actions">\n    <a routerLink="/policy-assistant" class="icon-btn">?</a>\n    <span class="icon-btn">\u{1F514}</span>\n    <div class="avatar">JS</div>\n    <div class="user">\n      <strong>{{ state().profile.fullName }}</strong>\n      <span>{{ state().profile.role }}</span>\n    </div>\n  </div>\n</header>\n', styles: ["/* src/app/layout/topbar/topbar.component.scss */\n.topbar {\n  height: 76px;\n  display: flex;\n  align-items: center;\n  justify-content: space-between;\n  padding: 0 24px;\n  background: rgba(255, 255, 255, 0.84);\n  -webkit-backdrop-filter: blur(10px);\n  backdrop-filter: blur(10px);\n  border-bottom: 1px solid var(--db-border);\n  position: sticky;\n  top: 0;\n  z-index: 5;\n}\n.eyebrow {\n  font-size: 12px;\n  color: var(--db-muted);\n  margin-bottom: 4px;\n}\n.top-actions {\n  display: flex;\n  align-items: center;\n  gap: 10px;\n}\n.icon-btn {\n  width: 36px;\n  height: 36px;\n  border-radius: 12px;\n  display: grid;\n  place-items: center;\n  background: #fff;\n  border: 1px solid var(--db-border);\n}\n.avatar {\n  width: 38px;\n  height: 38px;\n  border-radius: 50%;\n  display: grid;\n  place-items: center;\n  color: #a4005b;\n  background: #ffd7ec;\n  font-size: 13px;\n  font-weight: 800;\n}\n.user span {\n  display: block;\n  font-size: 12px;\n  color: var(--db-muted);\n}\n@media (max-width: 680px) {\n  .user,\n  .eyebrow {\n    display: none;\n  }\n}\n/*# sourceMappingURL=topbar.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TopbarComponent, { className: "TopbarComponent", filePath: "src/app/layout/topbar/topbar.component.ts", lineNumber: 12 });
})();
...
var AppShellComponent = class _AppShellComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _AppShellComponent, selectors: [["app-shell"]], decls: 6, vars: 0, consts: [[1, "shell"], [1, "main"], [1, "content"]], template: function AppShellComponent_Template(rf, ctx) {
    if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(AppShellComponent, [{
    type: Component,
    args: [{ selector: "app-shell", standalone: true, imports: [RouterOutlet, SidebarComponent, TopbarComponent], template: '<div class="shell">\n  <app-sidebar />\n  <main class="main">\n    <app-topbar />\n    <section class="content">\n      <router-outlet />\n    </section>\n  </main>\n</div>\n', styles: ["/* src/app/layout/app-shell/app-shell.component.scss */\n.shell {\n  display: flex;\n  min-height: 100vh;\n}\n.main {\n  flex: 1;\n  min-width: 0;\n}\n.content {\n  padding: 24px;\n}\n/*# sourceMappingURL=app-shell.component.css.map */\n"] }]
  }], null, null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(AppShellComponent, { className: "AppShellComponent", filePath: "src/app/layout/app-shell/app-shell.component.ts", lineNumber: 13 });
})();
...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-UQSH5JLT.js").then((m) => m.LoginComponent)
  },
  {
    path: "",
    component: AppShellComponent,
    children: [
      { path: "dashboard", loadComponent: () => import("./chunk-5L3A7BIU.js").then((m) => m.DashboardComponent) },
      { path: "profile", loadComponent: () => import("./chunk-5NVGF7HX.js").then((m) => m.ProfileAnalysisComponent) },
      { path: "missing-info", loadComponent: () => import("./chunk-FAZJWEJA.js").then((m) => m.MissingInfoComponent) },
      { path: "journey", loadComponent: () => import("./chunk-42SAVOLK.js").then((m) => m.JourneyComponent) },
      { path: "step/:id", loadComponent: () => import("./chunk-WEOMCKWR.js").then((m) => m.StepDetailsComponent) },
      { path: "policy-assistant", loadComponent: () => import("./chunk-ZS7BBAHZ.js").then((m) => m.PolicyAssistantComponent) },
      { path: "trainings", loadComponent: () => import("./chunk-TNHZKQ75.js").then((m) => m.TrainingsComponent) },
      { path: "access-requests", loadComponent: () => import("./chunk-IROAUSXQ.js").then((m) => m.AccessRequestsComponent) },
      { path: "readiness", loadComponent: () => import("./chunk-OR2HWDJZ.js").then((m) => m.ReadinessScoreComponent) },
      { path: "tasks", loadComponent: () => import("./chunk-FMGRSCKE.js").then((m) => m.TasksComponent) },
      { path: "manager", loadComponent: () => import("./chunk-QVGSAENV.js").then((m) => m.ManagerViewComponent) },
      { path: "reports", loadComponent: () => import("./chunk-Q63DFMLU.js").then((m) => m.ReportsComponent) },
      { path: "settings", loadComponent: () => import("./chunk-TYSJ3XS6.js").then((m) => m.SettingsComponent) },
      { path: "help", loadComponent: () => import("./chunk-WHPJWPGH.js").then((m) => m.HelpSupportComponent) }
    ]
  },
